...
export const tasks: Task[] = [
    {
        ...
        description:
            "Criar metas objetivas para que todo o time possa desenvolver.",
        dueDate: "2022-08-22",
    ...
    },
    {
        ...
        description:
            "Adequar as diretrizes da empresa conforme o solicitado pela gestão.",
        dueDate: "2022-07-12",
    ...
    },
    {
        ...
        title: "Reparo de QA",
        description:
            "Ajustar painéis de exibição do site Protery conforme solicitado pelo cliente.",
        dueDate: "2022-10-15",
        status: STATUS_LIST.TO_DO,
        creatorUserId: "5",
    },
