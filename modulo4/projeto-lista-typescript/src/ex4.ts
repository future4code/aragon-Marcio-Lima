...
function colaboradorMarketingPresencial(colaboradores: Pessoa[]): Pessoa[] {
  let quadroDeColaboradores = colaboradores.filter((colaborador) => {
...
console.log(colaboradorMarketingPresencial(colaboradores))
